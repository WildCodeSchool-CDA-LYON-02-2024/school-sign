...
export default function StudentDashboard() {
    ...
    const { fetchLessons } = useFetchLessons(studentClassId, setLessons, setError);
    ...
    const currentLessonId = ongoingLessons.length > 0 ? ongoingLessons[0].id : null;
    ...
    const filteredSignatures = currentLessonId
        ? signatures.filter(
            signature =>
                ...
                signature.userId === (studentId !== null ? studentId.toString() : undefined) // Convert studentId to string
        )
        : [];
